...
// accent heading, the four options, and a back-link. Pure presentation — the
// option wiring lands in C.3 (OptionList becomes a client island there).
export function QuestionCard({ q, step, total }: QuestionCardProps) {
